...
public class productadapters4  extends RecyclerView.Adapter<productAdapters.viewHolder>{
    ArrayList<productitem> plist;
    Context context;

    public productadapters4 (ArrayList<productitem> plist, Context context){
        this.plist = plist;
    ...
    public productAdapters.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.power2,parent,false);
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        ...
        public viewHolder(@NotNull View itemView){
            ...
            pimage=itemView.findViewById(R.id.productpower);
            details=itemView.findViewById(R.id.powerdetails);
            price=itemView.findViewById(R.id.powerrank);
            rank=itemView.findViewById(R.id.powerprice);
        }
    }
