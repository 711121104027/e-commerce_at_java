...
public class productadapters5  extends RecyclerView.Adapter<productAdapters.viewHolder>{
    ArrayList<productitem> plist;
    Context context;

    public productadapters5 (ArrayList<productitem> plist, Context context){
        this.plist = plist;
    ...
    public productAdapters.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.smartwatch2,parent,false);
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        ...
        public viewHolder(@NotNull View itemView){
            ...
            pimage=itemView.findViewById(R.id.productsamrt);
            details=itemView.findViewById(R.id.smartdetails);
            price=itemView.findViewById(R.id.smartrank);
            rank=itemView.findViewById(R.id.smartprice);
        }
    }
